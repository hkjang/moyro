...
import { adminApi, api, integrationsApi, } from "@/api/client";
...
export function IntegrationsPanel({ channels, currentTeamId, onClose, }) {
    ...
    const [serverBusy, setServerBusyState] = useState(false);
    const [logRows, setLogRows] = useState([]);
    const [pluginRows, setPluginRows] = useState([]);
    ...
    const pluginStateByID = useMemo(() => {
        const out = {};
        for (const row of pluginStatuses)
            out[row.plugin_id] = row.state;
        return out;
    }, [pluginStatuses]);
    ...
    async function onSetBusy(next) {
        if (!token)
            return;
        try {
            if (next)
                await adminApi.setServerBusy(token);
            else
                await adminApi.clearServerBusy(token);
    ...
    return (_jsxs("div", { className: "modal-backdrop", onClick: onClose, children: [_jsxs("div", { className: "modal-card integrations-panel", onClick: (e) => e.stopPropagation(), children: [_jsxs("header", { className: "integrations-header", children: [_jsx("h3", { style: { margin: 0 }, children: "System Console" }), _jsx("button", { type: "button", className: "action-btn", onClick: onClose, title: "\uB2EB\uAE30", children: "\u2715" })] }), _jsxs("div", { className: "admin-console-shell", children: [_jsx("nav", { className: "admin-console-tree", "aria-label": "System Console", children: ADMIN_NAV.map((section) => (_jsxs("div", { className: "admin-console-tree-section", children: [_jsx("div", { className: "admin-console-tree-heading", children: section.section }), section.items.map((item) => (_jsxs("button", { type: "button", className: "admin-console-tree-item", "aria-selected": tab === item.tab, onClick: () => setTab(item.tab), children: [_jsx("span", { children: item.label }), _jsx("small", { children: TAB_LABELS[item.tab] })] }, item.tab)))] }, section.section))) }), _jsxs("section", { className: "admin-console-panel", children: [_jsx("div", { className: "admin-console-panel-heading", children: _jsx("span", { children: TAB_LABELS[tab] }) }), error && _jsx("div", { className: "login-error", style: { margin: "0 0 12px" }, children: error }), freshPAT && (_jsxs("div", { className: "reveal-card", children: [_jsx("div", { style: { fontWeight: 600 }, children: "\uD1A0\uD070\uC774 \uC0DD\uC131\uB418\uC5C8\uC2B5\uB2C8\uB2E4. \uC9C0\uAE08 \uBCF5\uC0AC\uD574 \uB450\uC138\uC694. \uC774\uD6C4\uC5D0\uB294 \uB2E4\uC2DC \uBCFC \uC218 \uC5C6\uC2B5\uB2C8\uB2E4." }), _jsx("code", { className: "reveal-code", children: freshPAT.token }), _jsx("button", { type: "button", className: "btn-ghost", onClick: () => setFreshPAT(null), children: "\uD655\uC778" })] })), freshIncomingURL && (_jsxs("div", { className: "reveal-card", children: [_jsx("div", { style: { fontWeight: 600 }, children: "\uC778\uCEE4\uBC0D \uC6F9\uD6C5 URL\uC774 \uC0DD\uC131\uB418\uC5C8\uC2B5\uB2C8\uB2E4. \uC774 URL\uC744 \uACF5\uC720\uD558\uBA74 \uB204\uAD6C\uB098 \uBA54\uC2DC\uC9C0\uB97C \uBCF4\uB0BC \uC218 \uC788\uC2B5\uB2C8\uB2E4." }), _jsx("code", { className: "reveal-code", children: freshIncomingURL }), _jsx("button", { type: "button", className: "btn-ghost", onClick: () => setFreshIncomingURL(null), children: "\uD655\uC778" })] })), tab === "bots" && (_jsxs("div", { className: "integrations-body", children: [_jsxs("div", { className: "integrations-create", children: [_jsx("input", { className: "field-input", placeholder: "username (\uC601\uC18C\uBB38\uC790/\uC22B\uC790)", value: newBotName, onChange: (e) => setNewBotName(e.target.value) }), _jsx("input", { className: "field-input", placeholder: "\uD45C\uC2DC \uC774\uB984", value: newBotDisplay, onChange: (e) => setNewBotDisplay(e.target.value) }), _jsx("input", { className: "field-input", placeholder: "\uC124\uBA85 (\uC635\uC158)", value: newBotDesc, onChange: (e) => setNewBotDesc(e.target.value) }), _jsx("button", { className: "btn-primary", onClick: onCreateBot, style: { width: "auto", padding: "0 14px", height: 38 }, children: "\uBD07 \uB9CC\uB4E4\uAE30" })] }), _jsxs("ul", { className: "integrations-list", children: [bots.length === 0 && _jsx("li", { className: "chat-empty", style: { padding: 12 }, children: "\uB4F1\uB85D\uB41C \uBD07\uC774 \uC5C6\uC2B5\uB2C8\uB2E4." }), bots.map((b) => (_jsxs("li", { className: "integrations-row", children: [_jsxs("div", { style: { flex: 1 }, children: [_jsxs("div", { style: { fontWeight: 600 }, children: ["@", b.username] }), _jsx("div", { style: { color: "var(--muted)", fontSize: 12 }, children: b.description || "—" }), botTokens[b.user_id] && (_jsx("div", { style: { marginTop: 6 }, children: botTokens[b.user_id].length === 0
                                                    ...
                                                    return (_jsxs("li", { className: "integrations-row", style: inactive ? { opacity: 0.55 } : undefined, children: [_jsxs("div", { style: { flex: 1 }, children: [_jsxs("div", { style: { fontWeight: 600 }, children: ["@", u.username, inactive && (_jsx("span", { style: { marginLeft: 8, color: "var(--danger)", fontSize: 11 }, children: "\uBE44\uD65C\uC131" }))] }), _jsxs("div", { style: { color: "var(--muted)", fontSize: 12 }, children: [u.email, " \u00B7 ", u.roles || "system_user"] })] }), inactive ? (_jsx("button", { type: "button", className: "btn-ghost", style: { width: "auto", padding: "0 10px", height: 30 }, onClick: () => onReactivateUser(u.id), children: "\uD65C\uC131\uD654" })) : (_jsx("button", { type: "button", className: "btn-ghost", style: { width: "auto", padding: "0 10px", height: 30, color: "var(--danger)" }, onClick: () => onDeactivateUser(u.id, u.username), children: "\uBE44\uD65C\uC131\uD654" }))] }, u.id));
                                                        ...
                                                        }, onClick: () => onSetBusy(!serverBusy), children: serverBusy ? "Busy 해제" : "Busy 설정" }), _jsx("span", { className: serverBusy ? "admin-pill danger" : "admin-pill ok", children: serverBusy ? "busy" : "ready" })] }), _jsxs("div", { className: "admin-summary-grid", children: [_jsxs("div", { className: "admin-kv", children: [_jsx("span", { children: "SiteURL" }), _jsx("strong", { children: String(adminConfig?.ServiceSettings?.SiteURL ?? "—") })] }), _jsxs("div", { className: "admin-kv", children: [_jsx("span", { children: "Listen" }), _jsx("strong", { children: String(adminConfig?.ServiceSettings?.ListenAddress ?? "—") })] }), _jsxs("div", { className: "admin-kv", children: [_jsx("span", { children: "Plugin Dir" }), _jsx("strong", { children: String(adminConfig?.PluginSettings?.Directory ?? "—") })] }), _jsxs("div", { className: "admin-kv", children: [_jsx("span", { children: "File Driver" }), _jsx("strong", { children: String(adminConfig?.FileSettings?.DriverName ?? "—") })] })] }), _jsxs("ul", { className: "integrations-list", children: [clusterNodes.length === 0 && (_jsx("li", { className: "chat-empty", style: { padding: 12 }, children: "\uD074\uB7EC\uC2A4\uD130 \uB178\uB4DC \uC815\uBCF4\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4." })), clusterNodes.map((node) => (_jsx("li", { className: "integrations-row", children: _jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8, fontWeight: 600 }, children: [node.hostname || node.id, _jsx("span", { className: node.status === "OK" ? "admin-pill ok" : "admin-pill danger", children: node.status })] }), _jsxs("div", { style: { color: "var(--muted)", fontSize: 12, marginTop: 2 }, children: [node.version || node.server_version || "relaychat", " \u00B7 \uB9C8\uC9C0\uB9C9 ping ", node.last_ping_at ? new Date(node.last_ping_at).toLocaleTimeString() : "—"] })] }) }, node.id)))] }), _jsx("ul", { className: "integrations-list admin-log-list", children: logRows.map((row, idx) => (_jsx("li", { className: "integrations-row", children: _jsx("code", { children: row }) }, `${idx}-${row}`))) })] })), tab === "plugins" && (_jsxs("div", { className: "integrations-body", children: [_jsx("div", { className: "integrations-create admin-toolbar", children: _jsx("button", { type: "button", className: "btn-ghost", style: { width: "auto", padding: "0 12px", height: 34 }, onClick: refresh, children: "\uC0C1\uD0DC \uC0C8\uB85C\uACE0\uCE68" }) }), _jsxs("ul", { className: "integrations-list", children: [pluginRows.length === 0 && (_jsx("li", { className: "chat-empty", style: { padding: 12 }, children: "\uB85C\uB4DC\uB41C \uD50C\uB7EC\uADF8\uC778\uC774 \uC5C6\uC2B5\uB2C8\uB2E4." })), pluginRows.map((plugin, idx) => {
                                                        ...
                                                        return (_jsxs("li", { className: "integrations-row", children: [_jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8, fontWeight: 600 }, children: [String(plugin.name ?? pluginId), _jsx("span", { className: enabled ? "admin-pill ok" : "admin-pill", children: state })] }), _jsxs("div", { style: { color: "var(--muted)", fontSize: 12, marginTop: 2 }, children: [pluginId, " \u00B7 v", String(plugin.version ?? "dev")] })] }), _jsx("button", { type: "button", className: "btn-ghost", style: { width: "auto", padding: "0 10px", height: 30 }, onClick: () => onTogglePlugin(pluginId, enabled), children: enabled ? "비활성화" : "활성화" })] }, pluginId));
                                                    })] })] })), tab === "roles" && (_jsxs("div", { className: "integrations-body", children: [_jsx("div", { className: "integrations-create admin-toolbar", children: _jsx("button", { type: "button", className: "btn-ghost", style: { width: "auto", padding: "0 12px", height: 34 }, onClick: refresh, children: "\uC5ED\uD560 \uC0C8\uB85C\uACE0\uCE68" }) }), _jsxs("ul", { className: "integrations-list", children: [roles.length === 0 && (_jsx("li", { className: "chat-empty", style: { padding: 12 }, children: "\uC5ED\uD560 \uC815\uBCF4\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4." })), roles.map((role) => (_jsx("li", { className: "integrations-row", style: { alignItems: "flex-start" }, children: _jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8, fontWeight: 600 }, children: [role.display_name || role.name, role.built_in && _jsx("span", { className: "admin-pill", children: "built-in" })] }), _jsxs("div", { style: { color: "var(--muted)", fontSize: 12, marginTop: 2 }, children: [role.name, " \u00B7 \uAD8C\uD55C ", role.permissions.length, "\uAC1C"] }), _jsxs("div", { className: "admin-permission-list", children: [role.permissions.slice(0, 10).map((permission) => (_jsx("span", { children: permission }, permission))), role.permissions.length > 10 && _jsxs("span", { children: ["+", role.permissions.length - 10] })] })] }) }, role.id)))] })] })), tab === "jobs" && (_jsxs("div", { className: "integrations-body", children: [_jsxs("div", { className: "integrations-create", children: [_jsx("input", { className: "field-input", value: newJobType, onChange: (e) => setNewJobType(e.target.value), placeholder: "\uC791\uC5C5 \uD0C0\uC785", style: { flex: "1 1 180px" } }), _jsx("button", { type: "button", className: "btn-primary", style: { width: "auto", padding: "0 14px", height: 38 }, onClick: onCreateJob, children: "\uC791\uC5C5 \uC0DD\uC131" }), _jsx("button", { type: "button", className: "btn-ghost", style: { width: "auto", padding: "0 12px", height: 38 }, onClick: refresh, children: "\uC0C8\uB85C\uACE0\uCE68" })] }), _jsxs("ul", { className: "integrations-list", children: [jobs.length === 0 && (_jsx("li", { className: "chat-empty", style: { padding: 12 }, children: "\uC2E4\uD589 \uC911\uC778 \uC791\uC5C5\uC774 \uC5C6\uC2B5\uB2C8\uB2E4." })), jobs.map((job) => (_jsxs("li", { className: "integrations-row", children: [_jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8, fontWeight: 600 }, children: [job.type, _jsx("span", { className: job.status === "canceled" ? "admin-pill danger" : "admin-pill", children: job.status })] }), _jsxs("div", { style: { color: "var(--muted)", fontSize: 12, marginTop: 2 }, children: [job.id.slice(0, 8), " \u00B7 ", new Date(job.create_at).toLocaleString()] })] }), job.status !== "canceled" && job.status !== "success" && (_jsx("button", { type: "button", className: "btn-ghost", style: { width: "auto", padding: "0 10px", height: 30, color: "var(--danger)" }, onClick: () => onCancelJob(job.id), children: "\uCDE8\uC18C" }))] }, job.id)))] })] })), tab === "policies" && (_jsxs("div", { className: "integrations-body", children: [_jsxs("div", { className: "integrations-create admin-toolbar", children: [_jsx("button", { type: "button", className: "btn-ghost", style: { width: "auto", padding: "0 12px", height: 34 }, onClick: refresh, children: "\uC815\uCC45 \uC0C8\uB85C\uACE0\uCE68" }), _jsx("span", { className: "admin-pill ok", children: "Mattermost API" })] }), _jsx("div", { className: "admin-summary-grid", children: policyRows.map((row) => (_jsxs("div", { className: "admin-kv", children: [_jsx("span", { children: row.label }), _jsxs("strong", { children: [row.count !== undefined ? `${row.count} · ` : "", row.status] })] }, row.key))) }), _jsxs("ul", { className: "integrations-list", children: [policyRows.length === 0 && (_jsx("li", { className: "chat-empty", style: { padding: 12 }, children: "\uC815\uCC45 \uC0C1\uD0DC\uB97C \uBD88\uB7EC\uC624\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4." })), policyRows.map((row) => (_jsx("li", { className: "integrations-row", children: _jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8, fontWeight: 600 }, children: [row.label, _jsx("span", { className: `admin-pill ${row.tone ?? ""}`.trim(), children: row.status })] }), _jsxs("div", { style: { color: "var(--muted)", fontSize: 12, marginTop: 2 }, children: [row.detail, row.count !== undefined && ` · ${row.count} rows`] })] }) }, row.key))), _jsx("li", { className: "integrations-row", children: _jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8, fontWeight: 600 }, children: ["Global Retention", _jsx("span", { className: "admin-pill", children: globalRetentionPolicy?.message_deletion_enabled === true ||
                                                                                globalRetentionPolicy?.file_deletion_enabled === true
                                                                                ? "enabled"
                                                                                : "inactive" })] }), _jsxs("div", { style: { color: "var(--muted)", fontSize: 12, marginTop: 2 }, children: ["message ", String(globalRetentionPolicy?.message_retention_cutoff ?? 0), " · ", "file ", String(globalRetentionPolicy?.file_retention_cutoff ?? 0)] })] }) })] })] })), tab === "audit" && (_jsxs("div", { className: "integrations-body", children: [_jsxs("div", { className: "integrations-create", children: [_jsxs("label", { style: { display: "flex", alignItems: "center", gap: 6, fontSize: 13 }, children: ["\uBD84\uB958", _jsx("select", { className: "field-input", style: { width: 140 }, value: auditPrefix, onChange: (e) => setAuditPrefix(e.target.value), children: AUDIT_PREFIXES.map((p) => (_jsx("option", { value: p.value, children: p.label }, p.value || "all"))) })] }), _jsx("input", { className: "field-input", placeholder: "\uD589\uC704\uC790 username (\uC635\uC158)", value: auditActor, onChange: (e) => setAuditActor(e.target.value), style: { flex: "1 1 180px" } }), _jsx("button", { type: "button", className: "btn-ghost", style: { width: "auto", padding: "0 12px", height: 38 }, onClick: refresh, children: "\uC0C8\uB85C\uACE0\uCE68" })] }), _jsxs("ul", { className: "integrations-list", children: [auditRows.length === 0 && (_jsx("li", { className: "chat-empty", style: { padding: 12 }, children: "\uC870\uAC74\uC5D0 \uB9DE\uB294 \uAC10\uC0AC \uB85C\uADF8\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4." })), auditRows.map((row) => {
