...
const specs: Omit<StickerSpec, "id">[] = [
  ...
  // ── 반응 ────────────────────────────────────────────────────────────
  { pack: "reaction", caption: "굿!", pose: "thumbs", keywords: ["굿", "good", "좋아요", "따봉", "엄지"], eyes: "happy", mouth: "grin", prop: "👍", color: GREEN },
  { pack: "reaction", caption: "최고!", pose: "thumbs", keywords: ["최고", "짱", "베스트", "best", "대단"], eyes: "star", mouth: "grin", float: "sparkles", prop: "🏆", color: YELLOW },
  { pack: "reaction", caption: "짝짝짝", pose: "cheer", keywords: ["짝짝", "박수", "브라보", "클랩", "축하드"], eyes: "happy", mouth: "open", prop: "👏", float: "sparkles" },
  { pack: "reaction", caption: "OK!", pose: "thumbs", keywords: ["ok", "오케이", "오키", "옼", "넵", "넹", "네네"], eyes: "wink", mouth: "smile", prop: "👌", color: GREEN },
  { pack: "reaction", caption: "확인했어요", pose: "thumbs", keywords: ["확인했", "확인 완료", "확인함", "봤어", "체크", "봤습니다"], eyes: "dot", mouth: "smile", prop: "✅", color: GREEN },
  { pack: "reaction", caption: "알겠어요", pose: "thumbs", keywords: ["알겠", "알았", "이해했", "네 알", "알겠습니다"], eyes: "happy", mouth: "smile", prop: "🙆" },
  { pack: "reaction", caption: "고마워요", pose: "stand", keywords: ["고마워", "고맙", "감사", "땡큐", "thanks", "thx", "감사합니다"], eyes: "happy", mouth: "smile", blush: true, float: "hearts", prop: "🙏", color: PINK },
  { pack: "reaction", caption: "미안해요", pose: "cry", keywords: ["미안", "죄송", "송구", "sorry", "쏘리"], eyes: "closed", mouth: "wavy", sweat: true, brow: "sad" },
  { pack: "reaction", caption: "축하해요", pose: "cheer", keywords: ["축하", "생일", "경축", "congrat", "기념"], eyes: "happy", mouth: "grin", float: "confetti", prop: "🎉", color: PINK },
  { pack: "reaction", caption: "파이팅!", pose: "cheer", keywords: ["파이팅", "화이팅", "힘내", "아자", "fighting", "가즈아"], eyes: "star", mouth: "grin", prop: "✊", color: ORANGE },
  { pack: "reaction", caption: "응원해요", pose: "cheer", keywords: ["응원", "잘할", "잘 될", "할 수 있", "믿어"], eyes: "happy", mouth: "open", prop: "📣", float: "sparkles", color: ORANGE },
  { pack: "reaction", caption: "왜요?", pose: "cross", keywords: ["왜요", "왜?", "뭐지", "무슨", "어떻게?", "궁금"], eyes: "dot", mouth: "o", brow: "raised", float: "question" },
  // ── 업무 ────────────────────────────────────────────────────────────
  { pack: "work", caption: "회의 중", pose: "hold", keywords: ["회의", "미팅", "미팅중", "meeting", "콜중"], eyes: "dot", mouth: "flat", prop: "📋", color: PURPLE },
  { pack: "work", caption: "잠시만요", pose: "hold", keywords: ["잠시만", "잠깐", "잠깐만", "기다려", "곧", "조금만"], eyes: "dot", mouth: "wavy", prop: "⏳", sweat: true },
  { pack: "work", caption: "밥 먹자", pose: "hold", keywords: ["밥", "점심", "저녁", "식사", "먹자", "배고", "맛점"], eyes: "happy", mouth: "open", prop: "🍚", color: YELLOW },
  { pack: "work", caption: "커피 한잔", pose: "hold", keywords: ["커피", "카페", "티타임", "coffee", "라떼", "아아"], eyes: "happy", mouth: "smile", prop: "☕", color: ORANGE },
  { pack: "work", caption: "퇴근!", pose: "cheer", keywords: ["퇴근", "칼퇴", "집에", "퇴근합니다", "먼저 가"], eyes: "star", mouth: "grin", prop: "🎒", float: "sparkles", color: GREEN },
  { pack: "work", caption: "야근 중", pose: "hold", keywords: ["야근", "늦게", "밤샘", "새벽", "야근중"], eyes: "sleepy", mouth: "flat", prop: "🌙", float: "zzz", color: PURPLE },
  { pack: "work", caption: "집중 중", pose: "hold", keywords: ["집중", "작업중", "작업 중", "코딩", "몰입", "바쁨", "바빠"], eyes: "dot", mouth: "flat", prop: "💻" },
  { pack: "work", caption: "완료!", pose: "thumbs", keywords: ["완료", "끝났", "끝", "done", "마무리", "처리했", "했어요"], eyes: "happy", mouth: "grin", prop: "✅", float: "sparkles", color: GREEN },
  { pack: "work", caption: "확인 부탁해요", pose: "hold", keywords: ["확인 부탁", "확인해", "봐주", "검토 부탁", "리뷰 부탁", "확인 요청"], eyes: "dot", mouth: "smile", prop: "📎" },
  { pack: "work", caption: "수고했어요", pose: "stand", keywords: ["수고", "고생", "잘했", "훌륭", "굿잡", "good job"], eyes: "happy", mouth: "smile", blush: true, float: "sparkles", prop: "🌟", color: YELLOW },
  { pack: "work", caption: "곧 갈게요", pose: "run", keywords: ["곧 갈", "가는 중", "출발", "이동중", "가고 있", "도착"], eyes: "wide", mouth: "o", prop: "🏃", sweat: true },
  { pack: "work", caption: "메모 남겼어요", pose: "hold", keywords: ["메모", "남겼", "적어", "기록", "노트"], eyes: "dot", mouth: "smile", prop: "📝" },
  // ── 인사 ────────────────────────────────────────────────────────────
  { pack: "greeting", caption: "안녕하세요", pose: "wave", keywords: ["안녕", "하이", "hello", "hi", "반가", "처음 뵙"], eyes: "happy", mouth: "smile", prop: "👋", color: YELLOW },
  { pack: "greeting", caption: "좋은 아침", pose: "stand", keywords: ["좋은 아침", "굿모닝", "아침", "출근", "morning"], eyes: "happy", mouth: "grin", prop: "☀️", color: ORANGE },
  { pack: "greeting", caption: "잘 자요", pose: "slump", keywords: ["잘 자", "굿나잇", "잘자", "자러", "취침", "night"], eyes: "sleepy", mouth: "smile", prop: "🌙", float: "zzz", color: PURPLE },
  { pack: "greeting", caption: "다녀올게요", pose: "wave", keywords: ["다녀올", "다녀오", "외출", "잠깐 나갔", "자리 비"], eyes: "dot", mouth: "smile", prop: "👋" },
  { pack: "greeting", caption: "주말 잘 보내요", pose: "cheer", keywords: ["주말", "불금", "휴일", "연휴", "쉬세요"], eyes: "happy", mouth: "grin", prop: "🌴", float: "sparkles", color: GREEN },
  { pack: "greeting", caption: "환영해요", pose: "wave", keywords: ["환영", "웰컴", "welcome", "합류", "입사"], eyes: "star", mouth: "grin", float: "confetti", prop: "🎊", color: PINK },
  ...
  { pack: "cat", character: "cat", caption: "밥 달라냥", pose: "hold", eyes: "wide", mouth: "open", prop: "🐟", keywords: ["배고", "밥", "점심", "저녁", "간식", "먹을"] },
  ...
  { pack: "cat", character: "cat", caption: "간식 내놔", pose: "hold", eyes: "star", mouth: "grin", prop: "🍪", keywords: ["간식", "츄르", "디저트", "과자", "내놔"] },
  { pack: "cat", character: "cat", caption: "잘했다냥", pose: "thumbs", eyes: "happy", mouth: "grin", float: "sparkles", prop: "👑", keywords: ["잘했", "칭찬", "수고", "굿잡", "훌륭"] },
  { pack: "cat", character: "cat", caption: "알겠다냥", pose: "thumbs", eyes: "wink", mouth: "smile", keywords: ["알겠", "알았", "오케이", "ok", "넵"] },
  { pack: "cat", character: "cat", caption: "고맙다냥", pose: "stand", eyes: "happy", mouth: "smile", blush: true, prop: "🎀", keywords: ["고마워", "고맙", "감사", "땡큐"] },
  { pack: "cat", character: "cat", caption: "미안하다냥", pose: "cry", eyes: "tear", mouth: "wavy", sweat: true, keywords: ["미안", "죄송", "sorry", "실수"] },
  { pack: "cat", character: "cat", caption: "퇴근한다냥", pose: "cheer", eyes: "star", mouth: "grin", prop: "🌙", float: "sparkles", keywords: ["퇴근", "칼퇴", "집에", "먼저 가"] },
  // ── 멍이 — 신나고 다정한 강아지, 말끝에 "멍" ─────────────────────────
  { pack: "dog", character: "dog", caption: "산책 가자!", pose: "cheer", eyes: "star", mouth: "tongue", prop: "🦴", float: "sparkles", keywords: ["산책", "나가", "나갈래", "외출", "바람 쐬"] },
  { pack: "dog", character: "dog", caption: "반가워멍!", pose: "wave", eyes: "happy", mouth: "tongue", blush: true, prop: "👋", keywords: ["반가", "안녕", "하이", "hello", "오랜만"] },
  { pack: "dog", character: "dog", caption: "기다릴게멍", pose: "hold", eyes: "dot", mouth: "smile", prop: "⏳", keywords: ["기다릴", "기다려", "천천히 와", "언제 와", "대기"] },
  { pack: "dog", character: "dog", caption: "잘했어멍!", pose: "thumbs", eyes: "happy", mouth: "grin", float: "confetti", prop: "🏅", keywords: ["잘했", "대단", "최고", "짱", "굿"] },
  { pack: "dog", character: "dog", caption: "사랑해멍", pose: "stand", eyes: "happy", mouth: "tongue", blush: true, float: "hearts", keywords: ["사랑", "love", "좋아해", "하트", "럽"] },
  { pack: "dog", character: "dog", caption: "배고파멍", pose: "stand", eyes: "tear", mouth: "open", prop: "🍖", keywords: ["배고", "밥", "먹자", "점심", "야식"] },
  { pack: "dog", character: "dog", caption: "심심해멍", pose: "stand", eyes: "dot", mouth: "flat", float: "question", keywords: ["심심", "할 거 없", "지루", "뭐 하지", "놀아줘"] },
  { pack: "dog", character: "dog", caption: "놀자!", pose: "cheer", eyes: "star", mouth: "open", prop: "🎾", float: "sparkles", keywords: ["놀자", "놀래", "게임", "한판", "재밌"] },
  { pack: "dog", character: "dog", caption: "슬퍼멍", pose: "cry", eyes: "tear", mouth: "frown", brow: "sad", keywords: ["슬퍼", "슬프", "ㅠㅠ", "속상", "울고"] },
  { pack: "dog", character: "dog", caption: "확인했어멍", pose: "thumbs", eyes: "dot", mouth: "smile", prop: "✅", keywords: ["확인했", "확인 완료", "봤어", "체크", "봤습니다"] },
  { pack: "dog", character: "dog", caption: "파이팅멍!", pose: "cheer", eyes: "star", mouth: "grin", prop: "✊", keywords: ["파이팅", "화이팅", "힘내", "아자", "가즈아"] },
  { pack: "dog", character: "dog", caption: "잘 자멍", pose: "slump", eyes: "sleepy", mouth: "smile", float: "zzz", prop: "🌙", keywords: ["잘 자", "잘자", "굿나잇", "취침", "자러"] },
  // ── 곰돌이 — 느긋하고 따뜻한 곰 ──────────────────────────────────────
  { pack: "bear", character: "bear", caption: "괜찮아요", pose: "stand", eyes: "happy", mouth: "smile", blush: true, keywords: ["괜찮", "걱정 마", "문제없", "노프라블럼", "됐어"] },
  { pack: "bear", character: "bear", caption: "천천히 해요", pose: "hold", eyes: "dot", mouth: "smile", prop: "🍵", keywords: ["천천히", "급할 것", "여유", "느긋", "서두르지"] },
  ...
  { pack: "bear", character: "bear", caption: "든든하죠", pose: "thumbs", eyes: "happy", mouth: "grin", prop: "💪", keywords: ["든든", "믿어", "맡겨", "책임", "걱정 없"] },
  { pack: "bear", character: "bear", caption: "꿀잠 자요", pose: "hold", eyes: "sleepy", mouth: "smile", float: "zzz", prop: "🍯", keywords: ["꿀잠", "잘 자", "굿나잇", "푹 쉬", "자요"] },
  { pack: "bear", character: "bear", caption: "배불러요", pose: "hold", eyes: "closed", mouth: "grin", blush: true, prop: "🍯", keywords: ["배불", "잘 먹었", "맛있었", "든든하게", "식사 완료"] },
  { pack: "bear", character: "bear", caption: "힘내요", pose: "stand", eyes: "happy", mouth: "smile", prop: "🌻", float: "sparkles", keywords: ["힘내", "응원", "파이팅", "화이팅", "기운"] },
  { pack: "bear", character: "bear", caption: "고마워요", pose: "stand", eyes: "happy", mouth: "smile", blush: true, prop: "🎁", keywords: ["고마워", "고맙", "감사", "땡큐", "thanks"] },
  { pack: "bear", character: "bear", caption: "죄송해요", pose: "cry", eyes: "closed", mouth: "wavy", sweat: true, brow: "sad", keywords: ["죄송", "미안", "sorry", "실례", "양해"] },
  { pack: "bear", character: "bear", caption: "잠시 쉴게요", pose: "slump", eyes: "sleepy", mouth: "flat", prop: "🛋️", keywords: ["쉴게", "휴식", "잠깐 쉬", "브레이크", "자리 비"] },
  { pack: "bear", character: "bear", caption: "커피 타임", pose: "hold", eyes: "happy", mouth: "smile", prop: "☕", keywords: ["커피", "카페", "티타임", "coffee", "아아"] },
  { pack: "bear", character: "bear", caption: "수고 많았어요", pose: "stand", eyes: "happy", mouth: "grin", float: "sparkles", prop: "🌟", keywords: ["수고", "고생", "잘했", "고마웠", "훌륭"] },
  // ── 토끼 — 발랄하고 급한 토끼 ─────────────────────────────────────────
  { pack: "rabbit", character: "rabbit", caption: "빨리빨리!", pose: "run", eyes: "wide", mouth: "open", prop: "⏰", sweat: true, keywords: ["빨리", "서둘러", "급해", "얼른", "어서"] },
  ...
  { pack: "rabbit", character: "rabbit", caption: "당근이지!", pose: "thumbs", eyes: "star", mouth: "grin", prop: "🥕", keywords: ["당근", "당연", "물론", "그럼", "당연하지"] },
  { pack: "rabbit", character: "rabbit", caption: "헐 대박", pose: "cheer", eyes: "wide", mouth: "open", float: "sparkles", keywords: ["대박", "헐", "미쳤", "장난 아니", "실화"] },
  { pack: "rabbit", character: "rabbit", caption: "울지 마", pose: "cry", eyes: "dot", mouth: "smile", prop: "🤍", keywords: ["울지", "괜찮아", "토닥", "위로", "힘들지"] },
  ...
  { pack: "rabbit", character: "rabbit", caption: "OK 접수!", pose: "thumbs", eyes: "wink", mouth: "grin", prop: "📥", keywords: ["접수", "ok", "오케이", "받았", "확인했"] },
  { pack: "rabbit", character: "rabbit", caption: "야근이라니", pose: "hold", eyes: "tear", mouth: "frown", brow: "sad", prop: "🌙", keywords: ["야근", "늦게", "밤샘", "집에 못", "새벽"] },
  { pack: "rabbit", character: "rabbit", caption: "점심 뭐 먹지", pose: "hold", eyes: "dot", mouth: "o", float: "question", prop: "🍱", keywords: ["점심", "뭐 먹", "메뉴", "밥", "식사"] },
  { pack: "rabbit", character: "rabbit", caption: "주말이다!", pose: "cheer", eyes: "star", mouth: "grin", float: "confetti", prop: "🎈", keywords: ["주말", "불금", "휴일", "연휴", "쉬는 날"] },
  // ── 오리 — 엉뚱하고 웃긴 오리, "꽥" ─────────────────────────────────────
  ...
  { pack: "duck", character: "duck", caption: "됐고 밥", pose: "hold", eyes: "closed", mouth: "flat", prop: "🍜", keywords: ["됐고", "밥", "일단 밥", "먹고", "배고"] },
  { pack: "duck", character: "duck", caption: "어이없꽥", pose: "cross", eyes: "dot", mouth: "wavy", brow: "raised", keywords: ["어이없", "황당", "어처구니", "말도 안", "실화냐"] },
  { pack: "duck", character: "duck", caption: "잘가꽥", pose: "wave", eyes: "happy", mouth: "smile", prop: "👋", keywords: ["잘가", "안녕", "바이", "bye", "다음에"] },
  { pack: "duck", character: "duck", caption: "컨디션 최상", pose: "cheer", eyes: "star", mouth: "grin", float: "sparkles", prop: "💪", keywords: ["컨디션", "최상", "쌩쌩", "기분 좋", "에너지"] },
  { pack: "duck", character: "duck", caption: "회의 그만", pose: "hold", eyes: "sleepy", mouth: "frown", prop: "📋", keywords: ["회의", "미팅", "그만", "회의 또", "언제 끝"] },
  { pack: "duck", character: "duck", caption: "대충 살자", pose: "slump", eyes: "closed", mouth: "smile", prop: "🛌", keywords: ["대충", "귀찮", "느긋", "나중에", "적당히"] },
  { pack: "duck", character: "duck", caption: "아무튼 완료", pose: "thumbs", eyes: "wink", mouth: "grin", prop: "✅", keywords: ["완료", "끝", "done", "했음", "마무리"] },
  { pack: "duck", character: "duck", caption: "내 잘못 아님", pose: "cross", eyes: "dot", mouth: "o", sweat: true, keywords: ["잘못", "내 탓", "아님", "책임", "억울"] },
  { pack: "duck", character: "duck", caption: "굿나잇 꽥", pose: "thumbs", eyes: "sleepy", mouth: "smile", float: "zzz", prop: "🌙", keywords: ["굿나잇", "잘 자", "잘자", "자러", "취침"] },
  { pack: "duck", character: "duck", caption: "환영 꽥", pose: "wave", eyes: "happy", mouth: "open", float: "confetti", prop: "🎊", keywords: ["환영", "웰컴", "welcome", "합류", "입사"] },
];
