...
- Search, saved posts, public channel discovery, and a link-preview foundation
  (outbound previews are disabled by the offline-safe v0.2.2 runtime)
...
- A permission-aware SSE AI assistant. Conversation state is browser-session
  only; v0.2.2 does not claim RAG, durable AI history, or AI-triggered actions
...
The supported v0.2.2 topology is one moyro application container connected to
