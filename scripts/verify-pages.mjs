...
for (const releasePage of [
  ...
  if (!html.includes("v0.2.14")) failures.push(`v0.2.14 release marker is missing in ${relative(root, releasePage)}`);
  ...
  if (!html.includes('"dateModified": "2026-09-03"')) {
    failures.push(`2026-09-03 dateModified is missing in ${relative(root, releasePage)}`);
  }
}
...
if (sitemapDates.filter((date) => date === "2026-09-03").length !== 4
  || sitemapDates.filter((date) => date === "2026-08-30").length !== 1) {
  failures.push("sitemap must date current v0.2.14 pages at 2026-09-03 and the v0.2.1 gallery at 2026-08-30");
}
