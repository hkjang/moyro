...
for (const releasePage of [
  ...
  if (!html.includes("v0.2.19")) failures.push(`v0.2.19 release marker is missing in ${relative(root, releasePage)}`);
...
if (sitemapDates.filter((date) => date === "2026-09-07").length !== 4
  ...
  failures.push("sitemap must date current v0.2.19 pages at 2026-09-07 and the v0.2.1 gallery at 2026-08-30");
}
